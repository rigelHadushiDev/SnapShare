...
import { CreateUserReq, CreateUserRes, UserInfoDto } from './dtos/CreateUser.dto';
...
export class UsersController {
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'The user has been successfully created.', type: CreateUserRes })
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'The profile picture has been uploaded successfully.', type: CreateUserRes })
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'The current loged-in user has been successfully updated.', type: CreateUserRes })
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'The current loged-in user has been successfully archieved.', type: CreateUserRes })
    @ApiException(() => NotFoundException, { description: 'The loged in user has not been found. [key: "userNotFound" ]' })
    async archiveUser() {
    ...
    @ApiResponse({ status: HttpStatus.OK, description: 'The current loged-in user has been successfully deleted.', type: CreateUserRes })
